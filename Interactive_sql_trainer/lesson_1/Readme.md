...
#### Запросы, груповые операции

Выбрать уникальных авторов, книги которых хранятся в таблице book.
...
как осуществляется группировка данных по некоторому столбцу и вычисления над группой
